...
impl<'a> PacketQueue for &'a mut RefCellQueue {
...
mod tests {
    ...
    #[test]
    fn refcell_queue() {
        run_tests(&mut RefCellQueue::new());
    }

    #[test]
    fn simple_queue_is_send() {
        fn assert_send<T: Send>() {}

        assert_send::<SimpleConsumer<'static>>();
        assert_send::<SimpleProducer<'static>>();
    }
}
