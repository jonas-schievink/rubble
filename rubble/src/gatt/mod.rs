...
use crate::{
    att::{AttUuid, Attribute, AttributeProvider, Handle},
    utils::HexSlice,
    uuid::Uuid16,
    Error,
};
    ...
    pub fn new() -> Self {
        Self {
            attributes: [
                ...
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x0011),
                    value: HexSlice(b"Firmware revision"),
                },
                // Characteristic declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x0012),
                    value: HexSlice(&[0x02, 0x07, 0x00, 0x04, 0x2A]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                ...
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x0014),
                    value: HexSlice(&[0x02, 0x07, 0x00, 0x04, 0x2A]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x0015),
                ...
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x0017),
                    value: HexSlice(b"Manufacturer name"),
                },
                // Characteristic declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x0018),
                    value: HexSlice(&[0x02, 0x07, 0x00, 0x04, 0x2A]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x0019),
                    value: HexSlice(b"regulatory_cert"),
                },
                // Characteristic declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x001A),
                    value: HexSlice(&[0x02, 0x07, 0x00, 0x04, 0x2A]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x001B),
                    value: HexSlice(&[0x01, 0x0D, 0x00, 0x00, 0x00, 0x10, 0x01]),
                },
                // Profile declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2800)),
                    handle: Handle::from_raw(0x01C),
                    value: HexSlice(&[0x5D, 0xFE]),
                },
                // Characteristic declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x001D),
                    value: HexSlice(&[0x0A, 0x1E, 0x00, 0xF1, 0xFF]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x001E),
                    value: HexSlice(b"1"),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2901)),
                    handle: Handle::from_raw(0x001F),
                    value: HexSlice(b"Characteristic 1"),
                },
                // Characteristic declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x0020),
                    value: HexSlice(&[0x02, 0x21, 0x00, 0xF2, 0xFF]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x0021),
                    value: HexSlice(b"2"),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2901)),
                    handle: Handle::from_raw(0x0022),
                ...
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x0024),
                    value: HexSlice(b""),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2901)),
                    handle: Handle::from_raw(0x0025),
                    value: HexSlice(b"Characteristic 3"),
                },
                // Characteristic declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x0026),
                    value: HexSlice(&[0x10, 0x27, 0x00, 0xF4, 0xFF]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x0027),
                    value: HexSlice(b"4"),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2901)),
                    handle: Handle::from_raw(0x0028),
                    value: HexSlice(&[0x00, 0x00]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2901)),
                    handle: Handle::from_raw(0x0029),
                    value: HexSlice(b"Characteristic 4"),
                },
                // Characteristic declaration
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2803)),
                    handle: Handle::from_raw(0x002A),
                    value: HexSlice(&[0x0A, 0x1E, 0x00, 0xF1, 0xFF]),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2A00)),
                    handle: Handle::from_raw(0x002B),
                    value: HexSlice(b"5"),
                },
                Attribute {
                    att_type: AttUuid::Uuid16(Uuid16(0x2901)),
                    handle: Handle::from_raw(0x002C),
