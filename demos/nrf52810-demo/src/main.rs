...
const APP: () = {
    ...
    static mut BLE_R: Responder<BleChannelMap<GattServerComplex<'static>, NoSecurity>> = ();
    ...
    fn init() {
        ...
        let resp = Responder::new(
            tx,
            rx,
            L2CAPState::new(BleChannelMap::with_attributes(GattServerComplex::new())),
        );
